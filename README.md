...
| **Speed up** | `Ctrl + Alt + ]` | 10% faster. Takes effect on the next chunk. |
| **Speed down** | `Ctrl + Alt + [` | 10% slower. Takes effect on the next chunk. |
| **Reset speed** | `Ctrl + Alt + \` | Back to normal (1.0×). |
...
| On-the-fly speed | `Ctrl + Alt + ]` / `Ctrl + Alt + [` to adjust speed, `Ctrl + Alt + \` to reset. Persists across restarts. |
